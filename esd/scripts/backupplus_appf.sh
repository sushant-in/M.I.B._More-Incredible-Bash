...
touch /net/rcc/dev/shmem/backupplus_appf.mib

# Setup cleanup trap for proper lock file removal
cleanup_backupplus_appf() {
	rm -f /net/rcc/dev/shmem/backupplus_appf.mib 2>/dev/null
}
trap cleanup_backupplus_appf EXIT TERM INT
