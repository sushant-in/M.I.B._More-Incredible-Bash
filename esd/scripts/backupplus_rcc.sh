...
touch /net/rcc/dev/shmem/backupplus_rcc.mib

# Setup cleanup trap for proper lock file removal
cleanup_backupplus_rcc() {
	rm -f /net/rcc/dev/shmem/backupplus_rcc.mib 2>/dev/null
}
trap cleanup_backupplus_rcc EXIT TERM INT
