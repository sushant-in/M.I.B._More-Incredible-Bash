...
touch /net/rcc/dev/shmem/backupplus_system.mib

# Setup cleanup trap for proper lock file removal
cleanup_backupplus_system() {
	rm -f /net/rcc/dev/shmem/backupplus_system.mib 2>/dev/null
}
trap cleanup_backupplus_system EXIT TERM INT
