...
touch /net/rcc/dev/shmem/backupplus_special.mib

# Setup cleanup trap for proper lock file removal
cleanup_backupplus_special() {
	rm -f /net/rcc/dev/shmem/backupplus_special.mib 2>/dev/null
}
trap cleanup_backupplus_special EXIT TERM INT
