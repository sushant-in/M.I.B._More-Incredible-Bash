...
touch /net/rcc/dev/shmem/backupplus_adb.mib

# Setup cleanup trap for proper lock file removal
cleanup_backupplus_adb() {
	rm -f /net/rcc/dev/shmem/backupplus_adb.mib 2>/dev/null
}
trap cleanup_backupplus_adb EXIT TERM INT
