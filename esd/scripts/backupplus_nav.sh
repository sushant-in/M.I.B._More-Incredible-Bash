...
touch /net/rcc/dev/shmem/backupplus_nav.mib

# Setup cleanup trap for proper lock file removal
cleanup_backupplus_nav() {
	rm -f /net/rcc/dev/shmem/backupplus_nav.mib 2>/dev/null
}
trap cleanup_backupplus_nav EXIT TERM INT
