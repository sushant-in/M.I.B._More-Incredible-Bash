...
touch /net/rcc/dev/shmem/backupplus_bb.mib

# Setup cleanup trap for proper lock file removal
cleanup_backupplus_bb() {
	rm -f /net/rcc/dev/shmem/backupplus_bb.mib 2>/dev/null
}
trap cleanup_backupplus_bb EXIT TERM INT
