...
touch /net/rcc/dev/shmem/backupplus_app.mib

# Setup cleanup trap for proper lock file removal
cleanup_backupplus_app() {
	rm -f /net/rcc/dev/shmem/backupplus_app.mib 2>/dev/null
}
trap cleanup_backupplus_app EXIT TERM INT
