...
touch /net/rcc/dev/shmem/NavActiveIgnore_off.mib

# Setup cleanup trap for proper lock file removal
cleanup_NavActiveIgnore_off() {
	rm -f /net/rcc/dev/shmem/NavActiveIgnore_off.mib 2>/dev/null
}
trap cleanup_NavActiveIgnore_off EXIT TERM INT
