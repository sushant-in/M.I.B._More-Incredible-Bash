...
touch /net/rcc/dev/shmem/backupplus_all.mib

# Setup cleanup trap for proper lock file removal
cleanup_backupplus_all() {
	rm -f /net/rcc/dev/shmem/backupplus_all.mib 2>/dev/null
}
trap cleanup_backupplus_all EXIT TERM INT
