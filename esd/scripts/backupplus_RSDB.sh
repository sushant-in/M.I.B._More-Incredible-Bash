...
touch /net/rcc/dev/shmem/backupplus_RSDB.mib

# Setup cleanup trap for proper lock file removal
cleanup_backupplus_RSDB() {
	rm -f /net/rcc/dev/shmem/backupplus_RSDB.mib 2>/dev/null
}
trap cleanup_backupplus_RSDB EXIT TERM INT
