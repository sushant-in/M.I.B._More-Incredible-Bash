...
touch /net/rcc/dev/shmem/backupplus_media.mib

# Setup cleanup trap for proper lock file removal
cleanup_backupplus_media() {
	rm -f /net/rcc/dev/shmem/backupplus_media.mib 2>/dev/null
}
trap cleanup_backupplus_media EXIT TERM INT
